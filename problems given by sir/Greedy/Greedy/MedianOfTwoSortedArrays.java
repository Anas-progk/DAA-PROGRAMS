...
public class MedianOfTwoSortedArrays 
{
	...
	private static double findMedian(int[] A, int[] B) 
	{
		...
		while (start <= end) 
		{
			...
			System.out.println("AleftMax "+AleftMax+"\nBrightMin "+BrightMin);
			System.out.println("BleftMax "+BleftMax+"\nArightMin "+ArightMin);
			// Check if we have found the match
			if (AleftMax <= BrightMin && BleftMax <= ArightMin) 
			{
				System.out.println("AleftMax <= BrightMin && BleftMax <= ArightMin ***TRUE***");
			...
			{
				System.out.println("AleftMax <= BrightMin && BleftMax <= ArightMin ***NOT TRUE***");
				System.out.println("AleftMax > BrightMin ***TRUE***");
				end = i - 1;
			}
			...
			{
				System.out.println("AleftMax <= BrightMin && BleftMax <= ArightMin ***NOT TRUE***");
				System.out.println("BleftMax > ArightMin ***TRUE***");
				start = i + 1;
			}
		}
		return 0;
